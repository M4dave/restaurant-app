          ...
          >
            ...
            <Box sx={{ p: 2 }}>
              ...
              <Typography variant="body2" color="text.secondary">
                We use only the freshest ingredients to ensure that every meal is both delicious and nutritious.
              </Typography>
              {/* Description text */}
            </Box>
          </Paper>
        ...
        <Grid item xs={12} sm={6} md={4}>
          ...
          >
            ...
            <Box sx={{ p: 2 }}>
              ...
              {/* Heading for the content */}
              <Typography variant="body2" color="text.secondary">
                Enjoy a cozy and comfortable atmosphere that&apos;s perfect for dining with friends and family.
              </Typography>
              {/* Description text */}
            </Box>
          </Paper>
        ...
        <Grid item xs={12} sm={6} md={4}>
          ...
          >
            ...
            <Box sx={{ p: 2 }}>
              ...
              {/* Heading for the content */}
              <Typography variant="body2" color="text.secondary">
                Our friendly staff is dedicated to providing you with excellent service and a memorable dining experience.
              </Typography>
              {/* Description text */}
            </Box>
          </Paper>
